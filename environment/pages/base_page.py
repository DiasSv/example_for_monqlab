...
class BasePage():
    ...
    def is_element_to_be_clickable(self, how, what, timeout=5):
        try:
    ...
    def is_title_correct(self, what, timeout=5):
        try:
            WebDriverWait(self.browser, timeout).until(EC.title_contains(what))
        except TimeoutException:
            return False
